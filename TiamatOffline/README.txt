...
1. Импортиране на данни за новини:
   ...
   - Очаквано времетраене: около 1 минута в зависимост от вашата система
...
1. Стартиране на процеса на оптимизация:
   ...
   - Очаквано времетраене: 20+ часа в зависимост от вашата система (N_TRIALS=50 по подразбиране)
